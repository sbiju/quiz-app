...
from profiles.mixins import StaffRequiredMixin, LoginRequiredMixin
...
class QuizTake(LoginRequiredMixin, FormView):
    ...
    def dispatch(self, request, *args, **kwargs):
        self.quiz = get_object_or_404(Quiz, url=self.kwargs['quizname'])
    ...
    def final_result_anon(self):
        ...
        return render(self.request, 'dashboard.html', results)
